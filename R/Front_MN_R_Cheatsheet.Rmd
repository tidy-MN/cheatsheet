...
<h5 style="margin-left: 20px; color: #cfcfcf;"> Use this reference to read data, clean column names, make plots, process dates, filter and summarize data, join tables, and more. </h5> 
